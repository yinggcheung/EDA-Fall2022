...
#4
EPAair_O3_NC2018_select <- EPAair_O3_NC2018_raw%>%select("Date", "DAILY_AQI_VALUE", "Site.Name", "AQS_PARAMETER_DESC", "COUNTY", "SITE_LATITUDE", "SITE_LONGITUDE")

EPAair_O3_NC2019_select <- EPAair_O3_NC2019_raw%>%select("Date", "DAILY_AQI_VALUE", "Site.Name", "AQS_PARAMETER_DESC", "COUNTY", "SITE_LATITUDE", "SITE_LONGITUDE")

EPAair_PM25_NC2018_select <- EPAair_PM25_NC2018_raw%>%select("Date", "DAILY_AQI_VALUE", "Site.Name", "AQS_PARAMETER_DESC", "COUNTY", "SITE_LATITUDE", "SITE_LONGITUDE")

EPAair_PM25_NC2019_select <- EPAair_PM25_NC2019_raw%>%select("Date", "DAILY_AQI_VALUE", "Site.Name", "AQS_PARAMETER_DESC", "COUNTY", "SITE_LATITUDE", "SITE_LONGITUDE")
